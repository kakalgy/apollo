 ...
 * <p>
 * 快速选择算法的实现。
 * <p>它使用第一个，中间和最后一个值的中位数作为枢轴，并在递归级别的数量超过{@code 2lg(n)}时退回到堆排序，
 * 因此它以线性时间运行 平均而言，最坏的情况是{@code n log（n）}时间。</p>
 * </p>
 *
 * @lucene.internal
 */
public abstract class IntroSelector extends Selector {
     ...
     *
     * <p>
     * 将值保存在插槽<code> i </ code>中，以便以后可以用作枢轴，请参见{@link #comparePivot（int）}。
     * </p>
     */
     ...
     *
     * <p>
     * 将枢轴与<code> j </code>上的插槽进行比较，类似于{@link #compare（int，int）compare（i，j）}。
     * </p>
     */
